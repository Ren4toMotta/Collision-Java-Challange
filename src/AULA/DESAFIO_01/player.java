...
public class player extends Rectangle{
	...
	public player(String nome, char forma,int larg_painel, int alt_painel) {
		this.forma = forma;
	...
	public void moverPlauer(char direcao,int passo) {
	...
	public boolean veriAtivPlauyer(int px, int py) {
		this.ativado = false;
	...
	public boolean verifColisoesMuro(char D,int P, ArrayList<obstaculos> muros) {
		boolean colidiu = false;
		int oldX = this.x;
		int oldY = this.y;
		moverPlauer(D, P);
